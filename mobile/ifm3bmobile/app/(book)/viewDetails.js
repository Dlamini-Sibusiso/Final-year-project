                    ...
                    <View>
                        ...
                        <View style={{ marginTop: 5 }}>
                            ...
                            <View style={{ flexDirection: 'row', gap: 15, marginVertical: 10 }}>
                                <TouchableOpacity style={[styles.statusButton, selectedStatus === 'Approve' && { backgroundColor: '#4CAF50' },]} onPress={() => setSelectedStatus('Approve')}>
                                    <Text style={styles.statusButtonText}>Approve</Text>
                                </TouchableOpacity>

                                <TouchableOpacity style={[styles.statusButton, selectedStatus === 'Disapprove' && { backgroundColor: '#F44336' },]} onPress={() => setSelectedStatus('Disapprove')}>
                            ...
                            {selectedStatus === 'Disapprove' && (
                                <View style={{marginTop: 10}}>
                                    <Text style={styles.labelb}>Reason for Disapproval:</Text>
                                    <TextInput multiline numberOfLines={4} style={styles.textArea} value={statusInfo} onChangeText={setStatusInfo} placeholder="Explain why the booking was disapproved"/>
                                </View>
                            )}
